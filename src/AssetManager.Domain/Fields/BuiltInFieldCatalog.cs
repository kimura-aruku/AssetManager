...
public static class BuiltInFieldCatalog
{
    ...
    private static FieldDefinition[] CreateAll()
    {
        ...
        [
            ...
            BuiltIn(BuiltInFieldIds.Description, "説明", FieldType.MultilineText, SystemRole.Description),
            BuiltIn(BuiltInFieldIds.Notes, "備考", FieldType.MultilineText, SystemRole.Notes),
